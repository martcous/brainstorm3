        ...
        switch lower(varargin{2})
            ...
            case 'data'
                argout1 = {...
                     ...
                     {'.rhd'},               'Intan (*.rhd)',                        'EEG-INTAN'; ...
                     {'.plx'},               'Plexon (*.plx)',                       'EEG-PLEXON'; ...
                    };
            case 'raw'
                argout1 = {...
                     {'.*'},                 'MEG/EEG: 4D-Neuroimaging/BTi (*.*)',   '4D'; ...
            ...
            case 'dataout'
                argout1 = {...
                    ...
                    {'.csv'},   'ASCII: Coma-separated (*.csv)',               'ASCII-CSV'; ...
                    {'.txt'},   'ASCII: Space-separated with header (*.txt)',  'ASCII-SPC-HDR'; ...
                    {'.csv'},   'ASCII: Coma-separated with header (*.csv)',   'ASCII-CSV-HDR'; ...
            ...
            case 'montagein'
                argout1 = {...
                    ...
                    {'.csv'},     'Coma-separated montage files (*.csv)',     'CSV'; ...
