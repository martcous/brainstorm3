...
switch(filetype)
    case 'channel'
        ...
        body = struct("nbChannels",0,"transfMegLabels", "string",...
          "transfEegLabels","string","id","3fa85f64-5717-4562-b3fc-2c963f66afa6",...
    ...
    case 'timefreq'
        ...
        body = struct("measure", "string","method", "string",...
          ...
          "displayUnits", "string","id","3fa85f64-5717-4562-b3fc-2c963f66afa6",...
          "comment", "string","fileName", fileName,...
          "fileType", filetype,"histories", [{...
              "timeStamp": datestr(datevec(now),'yyyy-mm-ddTHH:MM:SS.FFFZ'),...
              "type": "string",...
    ...
    case 'stat'
        ...
        body = struct("df",0,"correction",true,...
            "type", filetype,"id","3fa85f64-5717-4562-b3fc-2c963f66afa6",...
            "comment", "string","fileName", fileName,...
    ...
    case 'headmodel'
        ...
        body = struct("type", "string","megMethod", "string",...
            ...
            "seegMethod", "string","id","3fa85f64-5717-4562-b3fc-2c963f66afa6",...
            "comment", "string","fileName", fileName,...
            "fileType", filetype,"histories", [{...
               "timeStamp": datestr(datevec(now),'yyyy-mm-ddTHH:MM:SS.FFFZ'),...
               "type": "string",...
