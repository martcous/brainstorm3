...
switch(filetype)
    case 'channel'
        ...
        body = struct("nbChannels",sItem.nbChannels,"transfMegLabels",findattribute("transfMegLabels"),...
          "transfEegLabels",findattribute("transfEegLabels"),"id",findattribute("id"),...
          "comment", findattribute("comment"),"fileName", fileName,...
    ...
    case 'timefreq'
        ...
        body = struct("measure", findattribute("measure"),"method", findattribute("method"),...
          "nAvg", 0,"colormapType", findattribute("colormapType"),...
          "displayUnits", findattribute("displayUnits"),"id",findattribute("id"),...
    ...
    case 'stat'
        ...
        body = struct("df",0,"correction",true,...
            "type", filetype,"id",findattribute("id"),...
            "comment", findattribute("comment"),"fileName", fileName,...
    ...
    case 'headmodel'
        ...
        body = struct("type", findattribute("type"),"megMethod", findattribute("megMethod"),...
            "eegMethod", findattribute("eegMethod"),"ecogMethod", findattribute("ecogMethod"),...
            "seegMethod", findattribute("seegMethod"),"id",findattribute("id"),...
            "comment", findattribute("comment"),"fileName", fileName,...
            "fileType", filetype,"histories", [{...
               "timeStamp": datestr(datevec(now),'yyyy-mm-ddTHH:MM:SS.FFFZ'),...
               "historyEvent": "None"...
    ...
    case 'matrix'
        ...
        %todo: body
        body = struct("nAvg", 0,"displayUnits", findattribute("displayUnits"),...
            "id",findattribute("id"),"comment", findattribute("comment"),"fileName", fileName,...
            "fileType", filetype,"histories", [{...
               "timeStamp": datestr(datevec(now),'yyyy-mm-ddTHH:MM:SS.FFFZ'),...
               "historyEvent": "None"...
             }],...
